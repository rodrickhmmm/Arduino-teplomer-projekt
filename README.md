...
## 4. Co lze v kódu upravit/změnit bez hrabání se ve stežějních částech kódu
   ...
   ```
   `DHT11` můžete změnit na typ senzoru, který používáte (pokud používáte ten přesný jak je napsán v [Na sestrojení budete potřebovat](#1-jak-zařízení-zapojit), tak nic nemusíte měnit)
